// FILTER TO ORDER OBJECTS BY A KEY IN A NATURAL LANGUAGE ORDER
// i.e. 1,2,3,10,11,a,b,c etc as opposed to alphanumerical 1,10,11,2,3,a,b,c etc

// See http://jsfiddle.net/wE7H2/3/

// E.g. use

//<li ng-repeat="item in items | orderBy:naturalSortFilter('name')">
//   {{ item.name }}
//</li>
...
(function () {
    ...
    angular.module("jmbNaturalSort", [])
        ...
        .run(["$rootScope", "naturalService", function($rootScope, naturalService) {
            $rootScope.naturalSortFilter = function (field) {
